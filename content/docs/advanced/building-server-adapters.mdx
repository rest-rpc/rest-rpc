...
import type { ImplementationTree, RouteImplementation } from "@rest-rpc/server";
...
implementation trees, but it does not know how Express, Fastify, Hono, NestJS,
or any other framework registers routes.
