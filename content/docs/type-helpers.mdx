...
export const api = {
	todos: {
		...
		watch: route
			.ws("/todos/:id/watch")
			.params(z.object({ id: z.string() }))
			.clientMessage("typing", z.object({ active: z.boolean() }))
			.clientMessage("rename", z.object({ title: z.string() }))
			.serverMessage("title", z.object({ title: z.string() })),
	},
};
```
...
// | { status: Exclude<HttpStatusCode, 200 | 404>; rawResponse: Response }
...
// | { type: "typing"; message: { active: boolean } }
// | { type: "rename"; message: { title: string } }

type WatchReceived = ClientReceived<typeof api.todos.watch>;
// { type: "title"; message: { title: string } }
