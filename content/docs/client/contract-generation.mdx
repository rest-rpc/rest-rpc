...
description: Generate a runtime contract from your server route declarations.
---
...
:::note[Using Contract-First Approach?]
If using the [Contract-First Approach](/docs/contract/declaration),
you can skip this step and import the shared contract directly in your client code.
:::
